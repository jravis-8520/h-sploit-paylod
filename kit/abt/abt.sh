...
echo -e "$blue ║$grn       $red creates$grn the$red payload$grn in a$red few seconds.$blue          ║"
echo -e "$blue ║$grn      I$red designed$grn this$red tool$grn as an easy way only,$blue        ║"
echo -e "$blue ║$red Input$grn the$red values$grn and$red payload created$grn in a$red few seconds$blue ║"
